...
class DailyReport:
    def __init__(self, username: str, at_school: bool, at_shanghai: str, ad_code: str, covid_patient: int,
        ...
        self.at_school = "在校" if at_school else "不在校"
        self.at_shanghai = at_shanghai
    ...
    def run(self):
        ...
        old_form_data = {
            ...
            "SFZX": "不在校", "SFCS": "|0", "SF": "", "DQJZS": "在其它地区", "STZK": "",
